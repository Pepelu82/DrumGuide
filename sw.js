const CACHE='drumguide-v10-37';
const CORE=['./','./index.html','./styles.css?v=10.37.0','./app.js?v=10.37.0','./icon.svg?v=10.37.0','./icon-192.png?v=10.37.0','./icon-512.png','./manifest.webmanifest?v=10.37.0'];
